...
def en_ejecucion(lote, ejecucion_text, tiempo_inicio_proceso):
...
def ejecutar_proceso(lote, noLotesPendientes_label, ejecucion_text, root, procesosEnEspera_text, terminados_text, obtenerResultadosBtn, procesos_terminados=[], tiempo_inicio_proceso=None):
    global nuevos_procesos
    if lote:  
        #Funcion para mostrar el proceso en ejecución
        tiempo_restante, tiempo_inicio_proceso = en_ejecucion(lote, ejecucion_text, tiempo_inicio_proceso)
        ...
        root.after(1000, ejecutar_proceso, lote, noLotesPendientes_label, ejecucion_text, root, procesosEnEspera_text, terminados_text, obtenerResultadosBtn, procesos_terminados, tiempo_inicio_proceso)
...
def generar_procesos(noProcesos_entry, ejecucion_text, noLotesPendientes_label, root, procesosEnEspera_text, terminados_text, obtenerResultadosBtn, relojGlobal_label):
    ...
    ejecutar_proceso(lote, noLotesPendientes_label, ejecucion_text, root, procesosEnEspera_text, terminados_text, obtenerResultadosBtn)  # Inicia el "bucle"
